...
public class Accountant 
{
	...
	public Bill prepareBill(int _billId, Customer _customer,  Order _order, DeliveryBoy _boy, String _date)
	{
		...
		new Controls().insertBill(newBill);
